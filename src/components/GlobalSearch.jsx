    ...
    <div ref={searchContainerRef} className="relative flex items-center w-full sm:w-auto">
      {isSearchOpen ? (
        ...
        <button
          ...
          className="flex items-center space-x-2 bg-white border border-gray-300 hover:border-gray-400 text-gray-700 hover:text-gray-900 px-3 sm:px-4 py-2 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md text-sm font-medium w-full sm:min-w-[200px] justify-start"
        >
