...
const ImageModal = ({ isOpen, onClose, document, title }) => {
        ...
        if (isOpen && document?.url) {
            ...
            if (token) {
                ...
                .then(blob => {
                    ...
                    // Clean up blob URL after component unmounts
                ...
                <div className="bg-white rounded-lg">
                    ...
                    <div className="flex justify-between items-center p-4 border-t bg-gray-50 rounded-b-lg">
                        <div className="text-sm text-gray-600">
                            <span className="font-medium">Type:</span> {document?.type?.replace('_', ' ').toUpperCase() || 'Document'}
                        </div>
