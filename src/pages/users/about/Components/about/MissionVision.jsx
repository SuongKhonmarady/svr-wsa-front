      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <span className="font-bold">- </span>នៅឆ្នាំ១៩៤៨ អង្គភាពរដ្ឋាករទឹកស្វាយរៀង ត្រូវបានបង្កើ់តឡើង ពីអ្នកជំនាញប្រទេសបារាំង ប្រើប្រាស់ប្រភពទឹកលើដី(ទន្លេវ៉ៃគោ)។<br/>
            <span className="font-bold">- </span>នៅឆ្នាំ១៩៥១ អ្នកជំនាញមកពីប្រទេសអាមេរិក បានសាងសង់ អាងអាកាស ដោយប្រើប្រាស់ទឹកក្រោមដី(អណ្ដូង)។<br/>
            <span className="font-bold">- </span>នៅឆ្នាំ១៩៨០ មានជំនួយក្នុងការស្ដារឡើងវិញពីអ្នកជំនាញនៃ ប្រទេសវៀតណាម។<br/>
            <span className="font-bold">- </span>នៅឆ្នាំ១៩៨៥ ធ្វើការតម្លើងបំពង់ PVC និងជួសជុលអាងអាកាស ឡើងវិញ ក្រោមគម្រោងរបស់អង្គការ OXFAM ។<br/>
            <span className="font-bold">- </span>នៅឆ្នាំ១៩៩៥ ជួសជុលបំពង់ក្រោមអាងអាកាស សាងសង់ អាគាររដ្ឋបាល និងតម្លើងម៉ាស៊ីនភ្លើងចំនួន 0២គ្រឿង ក្រោមគម្រោង របស់ SAWA។<br/>
            <span className="font-bold">- </span>ឆ្នាំ២០០៤-២០០៦ ទទួលបានគម្រោងស្ដារឡើងវិញប្រព័ន្ធ ចែកចាយទឹកស្អាត ដែលជាកម្ចីពីធនាគារអភិវឌ្ឍន៍អាស៊ី ADB-3232។<br/>
            <span className="font-bold">- </span>ឆ្នាំ២០២០-២០២៣ បានទទួលគម្រោងពីធនាគារអភិវឌ្ឍន៍ អាស៊ី ADB-3232 ដែលមានសមត្ថភាពផលិតបាន ៩,០០០ម៣/ថ្ងៃ។<br/>
            <span className="font-bold">- </span>នៅថ្ងៃទី០១ ខែកុម្ភៈ ឆ្នាំ២០២៤ បានចាប់ផ្ដើមអនុវត្តគម្រោង ពង្រីកសមត្ថភាពបន្ថែម ដែលជាជំនួយឥតសំណងរបស់រាជរដ្ឋាភិបាល ជប៉ុន តាមរយៈទីភ្នាក់ងារសហប្រតិបត្តិការអន្តរជាតិជប៉ុន JICA ដែល មានសមត្ថភាពផលិតបាន ៦,៨០០ម៣/ថ្ងៃ។
            </p>
