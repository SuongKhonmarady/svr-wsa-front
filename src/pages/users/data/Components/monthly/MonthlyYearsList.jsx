        ...
        <div ref={sectionRef} className="bg-gray-50 min-h-screen py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12">
                    <h1 className={`text-4xl font-bold text-gray-900 mb-4 transition-all duration-1000 ${isVisible
                ...
                {/* Loading State */}
                {loading && (
                    <div className={`flex justify-center items-center py-12 transition-all duration-2000 ${isVisible
                            ? 'opacity-100 transform translate-y-0'
                            : 'opacity-0 transform translate-y-8'
                        }`}>
                            ...
                            <div className={`transition-all duration-800 ${
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                                    {years.map((year, index) => (
                                        ...
                                        >
                                            <div
                                                className={`bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1 overflow-hidden border border-gray-200 ${
                                                    (isVisible && showContent)
                ...
                {!loading && !error && years.length > 0 && (
                    <div className={`mt-12 bg-white rounded-xl shadow-lg p-6 transition-all duration-1000 ${
                        (isVisible && showContent)
                            ? 'opacity-100 transform translate-y-0'
                            : 'opacity-0 transform translate-y-8'
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className={`text-center p-4 bg-blue-50 rounded-lg transition-all duration-800 hover:scale-105 transform ${
                                (isVisible && showContent)
                            ...
                            <div className={`text-center p-4 bg-green-50 rounded-lg transition-all duration-800 hover:scale-105 transform ${
                                (isVisible && showContent)
                                    ? 'opacity-100 translate-y-0'
                                    : 'opacity-0 translate-y-4'
                            ...
                            <div className={`text-center p-4 bg-purple-50 rounded-lg transition-all duration-800 hover:scale-105 transform ${
                                (isVisible && showContent)
                                    ? 'opacity-100 translate-y-0'
                                    : 'opacity-0 translate-y-4'
