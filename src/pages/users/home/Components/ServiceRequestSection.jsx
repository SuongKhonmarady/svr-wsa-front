      ...
      <div className="relative max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        <div className={`bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-1000 ${
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-0">
            {/* Content Section */}
            <div className={`px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-10 md:py-12 lg:py-16 transition-all duration-1000 delay-200 ${
              isVisible 
                ? 'opacity-100 transform translate-x-0' 
                : 'opacity-0 transform -translate-x-8'
            }`}>
              <div className="max-w-lg mx-auto lg:max-w-none">
                <h2 className={`text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6 font-khmer-title transition-all duration-1000 delay-300 ${
                  isVisible 
                    ? 'opacity-100 transform translate-y-0' 
                ...
                <p className={`text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 leading-relaxed transition-all duration-1000 delay-400 ${
                  isVisible 
                    ? 'opacity-100 transform translate-y-0' 
                    : 'opacity-0 transform translate-y-4'
                }`}>
                ...
                <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                  {[
                    ...
                    <div 
                      key={index}
                      className={`flex items-start space-x-2 sm:space-x-3 transition-all duration-1000 ${
                        isVisible 
                          ? 'opacity-100 transform translate-x-0' 
                ...
                <a
                  ...
                  className={`inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-all duration-1000 shadow-lg hover:shadow-xl group text-sm sm:text-base ${
                    isVisible 
            ...
            <div className={`relative lg:flex lg:items-center transition-all duration-1000 delay-300 ${
              ...
              <div className="relative px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-10 md:py-12 lg:py-16">
                <div className="text-center text-white">
                  {/* Large Icon */}
                  <div className={`mx-auto w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-white/10 rounded-full flex items-center justify-center mb-4 sm:mb-6 transition-all duration-1000 delay-500 ${
                    isVisible 
              ...
              {/* Decorative elements */}
              <div className={`absolute top-0 right-0 -mt-2 sm:-mt-4 -mr-2 sm:-mr-4 w-12 h-12 sm:w-16 sm:h-16 bg-white/5 rounded-full transition-all duration-1000 delay-700 ${
                isVisible 
                  ? 'opacity-100 transform scale-100' 
                  : 'opacity-0 transform scale-0'
              }`}></div>
              <div className={`absolute bottom-0 left-0 -mb-2 sm:-mb-4 -ml-2 sm:-ml-4 w-16 h-16 sm:w-24 sm:h-24 bg-white/5 rounded-full transition-all duration-1000 delay-800 ${
                isVisible 
                  ? 'opacity-100 transform scale-100' 
                  : 'opacity-0 transform scale-0'
              }`}></div>
